...
public class TestDirectoryExtension implements BeforeEachCallback, ParameterResolver {
    ...
    public Object resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext) {
        ...
        return switch (parameterName) {
            case OUTPUT_DIR -> store.get(OUTPUT_DIR, Path.class);
            case INPUT_DIR -> store.get(INPUT_DIR, Path.class);
            case INPUT_ROOT_DIR -> INPUT_BASE_PATH;
            default -> throw new IllegalArgumentException("Unsupported parameter: " + parameterName);
        };
    }
}
